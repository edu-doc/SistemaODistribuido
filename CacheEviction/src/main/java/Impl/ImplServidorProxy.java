    ...
    private void alterarOS(List<Object> lista) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            if (so != null) {
                ...
                saida.println("OS alterada na cache do proxy2");
                Logger.info("OS alterada na cache do proxy2");
            } else {
    ...
    private void removerOS(List<Object> lista) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            if (so != null) {
                ...
                saida.println("OS Removida na cache do proxy2");
                Logger.info("OS Removida na cache do proxy2");
            } else {
                saida.println("Os não encontrada na proxy2");
                Logger.info("Os não encontrada na proxy2");
            }
    ...
    private void buscarOS(List<Object> lista) throws IOException, ClassNotFoundException, MyPickException {
        ...
        if (so != null) {
            ...
            try {
                ...
                Logger.warning("Erro ao buscar nas proxys: " + e.getMessage());
                e.printStackTrace(); // Adiciona stack trace para depuração
            }
        }
