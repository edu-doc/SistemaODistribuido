...
public class BancoBackup {
    ...
    private No raiz;
    public static final BancoBackup instancia = new BancoBackup();
    private final LogBancoBackup logBanco;

    public BancoBackup() {
        this.raiz = null;
        this.logBanco = new LogBancoBackup();
        inicializar();
    }

    public  void inserir(No no) {
        synchronized(BancoBackup.class) {
